    ...
    <div className="setting-main-container2">
        ...
        <div className="setting-field">
            ...
            <div className="eventCreation-input-field">
                ...
                <button onClick={()=>setAdminUpdateSettingPopUpWindow(true)} className="btn btn-primary w-100">
                    Update
                </button>
            </div>
        </div>
        {adminUpdateSettingPopUpWindow && (<div handleClick={()=>setAdminUpdateSettingPopUpWindow(false)} className="student-Create-Event-Dashboard">
          <UpdateSetting handlecloseUpdateSettingWindow={()=>setAdminUpdateSettingPopUpWindow(false)}/>
        </div>)}
    </div>
  );
}
