...
const UpdateStaff = ({handlecloseUpdateStaffWindow}) => {
    ...
    return (
      <div className="staff-signup-main-container">
        <div className='closeCreateEventWindow' onClick={handlecloseUpdateStaffWindow}><IoMdCloseCircleOutline /></div>
        <p className="staff-head1">Update Student Details</p>
