      ...
      >
        <SwiperSlide>
          <div className="image-slide-content">
            ...
            <label>
              The lecturer can create a timetable for lectures and generate QR codes for them.
            </label>
        ...
        <SwiperSlide>
          <div className="image-slide-content">
            ...
            <label>
              Students can scan the QR-code to mark their attendance using SkyTicker mobile app.
            </label>
            <div className="sized-box"></div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="image-slide-content">
            ...
            <label>When students mark their attendance, they will get notification.</label>
            <div className="sized-box"></div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
